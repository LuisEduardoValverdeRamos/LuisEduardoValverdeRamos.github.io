...
Gotcha TOML: no insertar claves sueltas después de una tabla `[x]` o `[[x]]` — quedan absorbidas por ella (ya causó dos bugs: taxonomías fantasma `/true/` y links sociales desaparecidos).
